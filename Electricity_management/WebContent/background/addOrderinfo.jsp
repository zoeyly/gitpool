...
<div class="meassage" style=" width: 100%; height: 100%;     position: absolute;
    top: 50px;left:0px;background: white;">
		...
		<form id="insert" action="http://localhost:8080/Electricity_management/addOrderinfoServlet" method="post">
				 <table class="table" width="200" border="1" cellspacing="1" cellpadding="1">
					...
					<tr>
				   		<td colspan="2" >
				   			<input id="add" type="button" value="添加" onclick="document.getElementById('insert').submit();">
				   		</td>
				   	</tr>
						  </table>
