...
<div class="meassage" style=" width: 100%; height: 100%;     position: absolute;
    top: 50px;left:0px;background: white;">
		...
		<form id="insert" action="http://localhost:8080/Electricity_management/changeOrderinfoServlet" method="post">
				 <table class="table" width="200" border="1" cellspacing="1" cellpadding="1">
					...
					<tr>
					    <td>orderstatus:</td>
					    <td><input type="text" name="orderstatus"></br></td>
					</tr>
					<tr>
					    <td >
				   			paystatus:
				   		...
				   		<td>
				   			<input type="text" name="paystatus"></br>
				   		</td>
					</tr>
					<tr>
					    <td >
				   		...
				   		<td>
				   			<input type="text" name="ordertime"></br>
				   		</td>
					</tr>
					<tr>
					    <td >
				   		...
				   		<td>
				   			<input type="text" name="paytime"></br>
				   		</td>
					</tr>
					<tr>
					    <td >
				   		...
				   		<td>
				   			<input type="text" name="addrinfo"></br>
				   		</td>
					</tr>
					<tr>
					    <td >
				   		...
				   		<td>
				   			<input type="text" name="mask"></br>
				   		</td>
					</tr>
					<tr>
				   		<td colspan="2" >
				   			<input id="change" type="button" value="修改" onclick="document.getElementById('insert').submit();">
				   		</td>
				   	</tr>
						  </table>
