...
<%-- 				<form  method="get" action="">
					<table class="table"  border="1px" cellspacing="0" width="80%" height="20px">
						<tr>
						<td>
						<input type="checkbox" name="all" id="zong" value="复选框"  onclick="SelectAll()"/> 全选</br>
						</td>
						...
						<tr height="20px">
								<td><input name="Son" id="Son3" type="checkbox" style="zoom: 1.6;" value="<%=pageModel.getDatas().get(i).getCid()%>" /></td>
