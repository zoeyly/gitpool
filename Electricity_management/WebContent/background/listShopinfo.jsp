    ...
    top: 50px;left:0px;background: white;">
			...
			<form method="get" action="" >
					...
					<%
						 ...
						 if(obj!=null){// 
				        	  PageModel<Shoppinginfo> pageModel=(PageModel<Shoppinginfo>)obj;
					...
					<tr>
						...
						<td><%=pageModel.getDatas().get(i).getAid()%></td>
						<td><%=pageModel.getDatas().get(i).getNickname()%></td>
						<td><%=pageModel.getDatas().get(i).getMoney()%> </td>
						<td><%=pageModel.getDatas().get(i).getLasttime()%></td>
						<td><a href="#">修改</a></td>
						<td>
      	...
      	&nbsp;<a href="http://localhost:8080/Electricity_management/listShopinfoServlet?pageNo=1&pageSize=5">首页</a> 
      
      	<a href="http://localhost:8080/Electricity_management/listShopinfoServlet?pageNo=<%=pageModel.getPageNo()-1==0? pageModel.getPageNo(): pageModel.getPageNo()-1%>&pageSize=5">上一页</a>&nbsp;
      
      	<a href="http://localhost:8080/Electricity_management/listShopinfoServlet?pageNo=<%=pageModel.getPageNo()==pageModel.getTotalPageSize()? pageModel.getPageNo(): pageModel.getPageNo()+1%>&pageSize=5">下一页</a> 
      	
      	
      	<a href="http://localhost:8080/Electricity_management/listShopinfoServlet?pageNo=<%=pageModel.getTotalPageSize()%>&pageSize=5">尾页</a>
      	&nbsp;
      	第<select onChange="if(this.value==options[selectedIndex].value){location='http://localhost:8080/Electricity_management/listShopinfoServlet?pageNo='+this.value+'&pageSize=5'}">
