...
/**
 * Servlet implementation class WebContentSrevlet
 */
@WebServlet("/findProductSrevlet")
public class findProductSrevlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public findProductSrevlet() {
        super();
