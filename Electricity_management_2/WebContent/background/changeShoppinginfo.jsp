...
<div class="meassage" style=" width: 100%; height: 100%;     position: absolute;
    top: 50px;left:0px;background: white;">
		...
		<form id="insert" action="http://localhost:8080/Electricity_management/changeShoppinginfoServlet" method="post">
				 <table class="table" width="200" border="1" cellspacing="1" cellpadding="1">
					...
					<tr>
					    ...
					    <td><input type="text" name="money"></br></td>
					</tr>
					<tr>
					<tr>
					    <td>
					    ...
					    <td><input type="text" name="lasttime"></br></td>
					</tr>
					<tr>
				   		<td colspan="2" >
