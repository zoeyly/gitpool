    ...
    top: 50px;left:0px;background: white;">
			...
			<form method="get" action="" >
					...
					<%
						 ...
						 if(obj!=null){// 
				        	  PageModel<Rule> pageModel=(PageModel<Rule>)obj;
					...
					<tr>
						...
						<td><%=pageModel.getDatas().get(i).getSize()%></td>
      	...
      	&nbsp;<a href="http://localhost:8080/Electricity_management/listRuleServlet?pageNo=1&pageSize=5">首页</a> 
      
      	<a href="http://localhost:8080/Electricity_management/listRuleServlet?pageNo=<%=pageModel.getPageNo()-1==0? pageModel.getPageNo(): pageModel.getPageNo()-1%>&pageSize=5">上一页</a>&nbsp;
      
      	<a href="http://localhost:8080/Electricity_management/listRuleServlet?pageNo=<%=pageModel.getPageNo()==pageModel.getTotalPageSize()? pageModel.getPageNo(): pageModel.getPageNo()+1%>&pageSize=5">下一页</a> 
      	
      	
      	<a href="http://localhost:8080/Electricity_management/listRuleServlet?pageNo=<%=pageModel.getTotalPageSize()%>&pageSize=5">尾页</a>
      	&nbsp;
      	第<select onChange="if(this.value==options[selectedIndex].value){location='http://localhost:8080/Electricity_management/listRuleServlet?pageNo='+this.value+'&pageSize=5'}">
