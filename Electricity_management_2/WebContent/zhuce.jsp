...
<html>
	...
	<body>
		...
		<div class="down">
			<form id="insert" name="loginForm" action="zhuceServlet" method="post">
				...
				<div style="height: 20%; font-size: 20px;padding-left: 15%;color: white;margin-top: 15px;">
					用户名：
					<br />
					<input id="loginname" name="loginname" style="border: 1px solid silver; border-radius: 5px;background-color: ;width: 200px;height: 25px;" placeholder="请输入用户名" /><br />
					...
					<div>
						...
						<input onclick="document.getElementById('insert').submit();" style="border: 1px solid silver;width: 100px;height: 30px;position: absolute;top:282px;left:50%;background-color: ;text-align: center;"value="注册"></input>
					</div>
			</form>
