	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if("1".equals(command)){
			...
			if(mAcc!=null){
				...
				response.sendRedirect("background/loginCate.jsp");
			}else{
		...
		pw.append("}");
		pw.append("</script>");
		pw.append("<body background=\"background/img/a.jpg\" style=\"background-size: 1400px 600px;background-repeat: no-repeat;\">");
		pw.append("<form name=\"loginForm\" action=\"LoginServlet\" method=\"post\"> ");
